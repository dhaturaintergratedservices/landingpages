...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 pt-5">
                    <div class="h1 pwd fon1 col-sm-12 c1 pb-5" style="padding-left:40px ;"><b>Driving Cybersecurity and Digital Transformation</b></div>
                </div>
                <div class="col-lg-5">
                    <div class="p3cptform card bg-light p-4 mt-1"> 
                    <form method="post" actiion="security.php" class="pt-2">
        ...
        <div class="container p-5">
            <div class="row">
                <div class="col-lg-5 pt-5">
                    <div class="h1 fon1 col-sm-8 c2"><b>Secure Your Cyberspace,<br> Secure Your Digital<br> Assets
                             </b></div>

                    <div class="col-lg-10 c2">We at Adiroha solutions Improve the security of your organization with our customized solutions to maintain digital security. We follow a strategical process to protect your organisations being in the the front lines of your business.</div>
    ...
    <section id="p3sec3">
        <div class="container p-5 c1">
            <div class="row">

                <div class="col-lg-3 col-md-6 mt-3">
                    <div class="r2wdbox p-5">
                        <i class="fa-solid fa-book-open-reader wdicon text-center mx-auto d-block"></i>
                        <div class="h6 pt-3 text-center wd"><b>Cyber Education</b></div>
                        <p class="text-center">trainings,coursesand awarness</p>
                    </div>
                </div>

                <div class="col-lg-3 col-md-6 mt-3">
                    <div class="r2wdbox p-5">
                        <i class="fa-solid fa-shield-virus wdicon text-center mx-auto d-block"></i>
                        <div class="h6 pt-3 text-center wd"><b>360 Degrees Protection</b></div>
                        <p class="text-center"> we provide all round Complete protection </p>
                    </div>
                </div>

                <div class="col-lg-3 col-md-6 mt-3">
                    <div class="r2wdbox p-5">
                        <i class="fa-solid fa-people-group wdicon text-center mx-auto d-block"></i>
                        <div class="h6 pt-3 text-center wd"><b>Cyber Security Strategic Consulting</b></div>
                        <p class="text-center">We solve your security problems</p>
                    </div>
                </div>

                <div class="col-lg-3 col-md-6 mt-3">
                    <div class="r2wdbox p-5">
                        <i class="fa-solid fa-bug-slash wdicon text-center mx-auto d-block"></i>
                        <div class="h6 pt-3 text-center wd"><b>coverage for threats</b></div>
                        <p class="text-center">Defence against internal and external threats</p>
                    </div>
                </div>
  ...
  <div class="col-lg-4 col-md-6">
                    <div class="r2wdbox2 p-4">
                        <i class="fa-solid fa-server r2wdicon2 text-center mx-auto d-block"></i>
                        <div class="h4 text-center pt-3"><b> Server Security Hardening</b></div>
                        <p class="text-center col-sm-10 mx-auto"> Protect and secure a server against cyberattacks  </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="r2wdbox2 p-4">
                        <i class="fa-solid fa-shield r2wdicon2 text-center mx-auto d-block"></i>
                        <div class="h4 text-center pt-3"><b>VAPT </b></div>
                        <p class="text-center col-sm-10 mx-auto">Vulnerability Assessment and Penetration Testing </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="r2wdbox2 p-4">
                        <i class="fa-solid fa-file-shield r2wdicon2 text-center mx-auto d-block"></i>
                        <div class="h4 text-center pt-3"><b>Annual Security Program </b></div>
                        <p class="text-center col-sm-10 mx-auto"> substantial value from security testing investments.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="r2wdbox2 p-4">
                        <i class="fa-solid fa-exclamation r2wdicon2 text-center mx-auto d-block"></i>
                        <div class="h4 text-center pt-3"><b>Phishing Stimulators</b></div>
                        <p class="text-center col-sm-10 mx-auto"> helping employees recognize, avoid, and report potential threats </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="r2wdbox2 p-4">
                        <i class="fa-solid fa-user-gear r2wdicon2 text-center mx-auto d-block"></i>
                        <div class="h4 text-center pt-3"><b>Corporate Services</b></div>
                        <p class="text-center col-sm-10 mx-auto">economically feasible security services </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="r2wdbox2 p-4">
                        <i class="fa-solid fa-chalkboard-user  r2wdicon2 text-center mx-auto d-block"></i>
                        <div class="h4 text-center pt-3"><b>Anti-Phishing Trainings</b></div>
                        <p class="text-center col-sm-10 mx-auto"> education on the clear dangers of phishing attacks for an organization. </p>
        ...
        <div class="container p-5">
            <div class="row c1">
                <div class="col-sm-4 mx-auto texttop">
                    <div class="h4 col-sm-8"><b>We also provide security for apps!</b></div>
                    <div class="">We know remote security works in a diffeent way. Stay and communicate with your team when ever you are with Adiroha mobile app for  <span class="c5">Android</span> and <span class="c5">iOS</span>devices security.</div>
