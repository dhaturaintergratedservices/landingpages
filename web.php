...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 pt-5">
                    <div class="h1 pwd fon1 col-sm-12 c2 pb-5" style="padding-left:40px ;"><b>Professional Website Design at affordable prices</b></div>
                </div>
                <div class="col-lg-5">
        ...
        <div class="container p-5">
            <div class="row">
                <div class="col-lg-5 pt-5">
                    <div class="h1 fon1 col-sm-8"><b>We design<br> websites </br>
                            that deliver results </b></div>

                    <div class="col-lg-10">We at Adiroha solutions combine design and technology to help our clients achieve their goal in this ever evolving digital era. We are committed to design compelling websites, applications and out unique brand innovating to help you dominate the competition.</div>
    ...
    <section id="p3sec4" class="fon1">
        <div class="container pt-5">
            <div class="row p-5">


                <div class="col-lg-4 col-md-6">
                    <div class="wdbox2 p-4">
                        <i class="fa-solid fa-mobile-screen-button wdicon2 text-center mx-auto d-block"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="wdbox2 p-4">
                        <i class="fa-solid fa-magnifying-glass wdicon2 text-center mx-auto d-block"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="wdbox2 p-4">
                        <i class="fa-regular fa-window-restore wdicon2 text-center mx-auto d-block"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="wdbox2 p-4">
                        <i class="fa-regular fa-envelope wdicon2 text-center mx-auto d-block"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="wdbox2 p-4">
                        <i class="fa-solid fa-indian-rupee-sign wdicon2 text-center mx-auto d-block"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="wdbox2 p-4">
                        <i class="fa-regular fa-clock wdicon2 text-center mx-auto d-block"></i>
        ...
        <div class="container p-5">
            <div class=" text-center h1"><b>helps +156.000 people <br>communicate efficiently</b></div>
            ...
            <div class="row pt-5">
                ...
                <div class="col-lg-4 mt-2 col-md-6">
                    <div class="wdbox3 card p-5">
                        <i class="fa-solid fa-quote-left mx-auto d-block text-center wdicon2"></i>
...
<!--
        <div class="container">
            ...
            <div class="text-center c2 h1 col-sm-6 mx-auto fw"><b>Join Chatter today <br>
            ...
            <div class="text-center tctxt p-2">After clicking “Get started” button you agree with our <a href="">Terms and Conditions.</a></div>
            ...
            <div class="text-center c5 pt-3">Meet Chatter customers</div>
